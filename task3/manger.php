...
?>
<div class="layer">
<h2 class="text-center text-light h-cliants w-50 m-auto py-2 text-capitalize ">mangers</h2>
...
<?php
      while($row= mysqli_fetch_assoc($dbResult))
      {
          ...
          <ul>
            <li> <h6 class="text-white lead"><?php echo $row['firstName1']." ----------------------------- " .
             $row['firstName2']."<br/>";?> </h6></li>
          </ul>  
