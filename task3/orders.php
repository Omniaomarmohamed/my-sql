...
?>
<div class="layer">
<h2 class="text-center text-light h-cliants w-50 m-auto py-2 text-capitalize ">our orders</h2>
...
<?php
      while($row= mysqli_fetch_assoc($dbResult))
      {
          ...
          <ul>
            <li> <h6 class="text-white lead"><?php echo $row['customerName']." ----------------------------- " .
             $row['COUNT(orders.orderNumber)']."<br/>";?> </h6></li>
          </ul>  
